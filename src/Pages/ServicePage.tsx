...
export default function ServicePage() {
  ...
  return (
    ...
    <div className="text-center py-16 ">
     ...
     data-aos-duration="3000" className="grid lg:grid-cols-3 gap-8 pt-10 pb-10">
      <Link to={""}>
  <div className="bg-[#FBFAFB] hover:shadow-sm text-center items-center border border-gray-300 p-3 justify-center transition-transform duration-200 ease-linear transform group">
   ...
   <h1 className="text-[28px] text-start ">Professionally Edited Photos </h1>
   <h1 className="text-[28px] text-start ">Videographer Option </h1>

   <p className="text-start text-[24px] italic text-[#1f1f1f] ">Capture your special day with my signature wedding package. Enjoy full-day coverage, professionally edited photos, and a beautiful online gallery to share with loved ones. </p>
...
<Link to={""}>
  <div className="bg-[#FBFAFB] hover:shadow-sm text-center items-center border border-gray-300 p-3 justify-center transition-transform duration-200 ease-linear transform group">
   ...
   <h1 className="text-[28px] text-start ">In Studio or On Location </h1>
   <h1 className="text-[28px] text-start ">Guidance on Posing & Dress</h1>
   <h1 className="text-[28px] text-start ">Digital & Print Delivery </h1>

   <p className="text-start text-[24px] italic text-[#1f1f1f] ">Enjoy a personalized portrait session with my own guidance that will highlight your unique personality, with expertly edited photos delivered in high resolution. </p>
   <h3 className="text-[24px] pt-2  ">Per Session</h3>
...
<Link to={""}>
  <div className="bg-[#FBFAFB] hover:shadow-sm text-center items-center border border-gray-300 p-3 justify-center transition-transform duration-200 ease-linear transform group">
   ...
   <p className="text-start text-[24px] italic text-[#1f1f1f] ">Celebrate your love with a romantic engagement session at your favorite location, complete with professionally edited, high-resolution images to cherish forever.</p>
   <h3 className="text-[24px] pt-2  ">Per Session</h3>
 ...
 <Link to={'/contact'}>
 <button className="justify-center cursor-pointer text-center mx-auto items-center mb-12 flex mt-6 text-[28px] bg-[#E9E0D8] hover:text-[#bba085] py-4 px-10">Book Now</button>
 </Link>
...
<div  data-aos="fade-up"
    ...
    >
      ...
      {/* Content */}
      <div data-aos="fade-up"
     data-aos-anchor-placement="top-bottom" className="relative z-10 text-center text-black max-w-[640px] px-4">
