...
export default function ContactPage() {
  ...
  return (
    ...
    <div  className="text-center py-16 ">
      <h1 className=" text-[24px] tracking-[10px] text-[#bba085] " >Contact</h1>
     ...
     data-aos-anchor-placement="top-bottom" className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
    ...
    <h1 className="text-[34px] text-[#bba085] pt-2 great-vibes-regular">Enquire Now</h1>
