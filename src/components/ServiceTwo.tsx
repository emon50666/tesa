 ...
 import copul from "../assets/images/copul.png";
 import wflower from "../assets/images/wflower.png";
...
export default function ServiceTwo() {
  return (
    <div className="relative mb-20 container mx-auto flex flex-col md:flex-row items-center justify-center w-full min-h-screen bg-gray-50   ">
     ...
     data-aos-duration="3000" className="relative  w-full  bg-left   h-[800px] md:bg-contain  bg-no-repeat "  style={{ backgroundImage: `url(${copul})` }}>
     ...
     data-aos-duration="3000" className="flex flex-col items-center">
          ...
          I will ensure your wedding day memories are preserved in stunning, timeless photographs that you will cherish for a lifetime.
          </p>
        </div>
      </div>
    </div>
