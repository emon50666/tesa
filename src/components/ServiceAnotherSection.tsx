...
import ser9 from "../assets/images/ser9.png"
import ser10 from "../assets/images/ser10.png"
import { Link } from "react-router"

export default function ServiceAnotherSection() {
  return (
    <div className="container mx-auto bg-[#FBFAFB] py-10 ">
         <div className="flex flex-col md:flex-row space-y-3   gap-4 md:space-x-5">
      {/* Image Section */}
      <div data-aos="fade-up"
     data-aos-duration="3000" className="w-full lg:w-1/2 hidden lg:block">
        <img
      ...
      {/* Text Section */}
      <div data-aos="fade-up"
     data-aos-anchor-placement="top-bottom" className="w-full lg:w-1/2 pt-10 text-center md:text-start md:px-10">
        <h1 className="text-[34px] pt-2 great-vibes-regular">Quality Guaranteed</h1>
  ...
  Visit My Blog
        ...
        <p data-aos="fade-up"
     data-aos-duration="3000" className="mt-4 text-xl md:text-[28px] px-2 leading-relaxed">
         
        On your big day, you can count on me to turn fleeting moments into timeless treasures you will cherish for generations.
        </p>
        {/* Image Section */}
      <div data-aos="fade-up"
     data-aos-duration="3000" className="w-full h-full pt-10">
        <img
